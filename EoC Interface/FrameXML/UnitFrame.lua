...
function UnitFramePortrait_Update (self)
	if ( self.portrait ) then
		...
		if (name == "Sha of Fear") then
			self.portrait:SetTexture("Interface\\UnitFrames\\ShaOfFear");
		elseif (name == "Manifestation") then
			self.portrait:SetTexture("Interface\\UnitFrames\\manifestation");
		else
