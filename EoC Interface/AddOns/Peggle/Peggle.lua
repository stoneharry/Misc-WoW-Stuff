...
["_PUBLISH_SCORE"]="[Peggle]: %s just scored %s points on %s!",
["_PUBLISH_DUEL_W"]="[Peggle]: %s just defeated %s in a Peggle Duel!",
["_PUBLISH_DUEL_L"]="[Peggle]: %s was just defeated by %s in a Peggle Duel!",
...
PeggleData.settings={mouseOnTrans=1,mouseOffTrans=.6,showMinimapIcon=true,openFlightStart=true,openDeath=true,openLogIn=false,openDuel=true,closeFlightEnd=false,closeReadyCheck=true,closeCombat=true,closeDuelComplete=false,closePeggleLoot=false,inviteChat=true,inviteRaid=false,inviteMinimap=true,inviteDecline=false,hideOutdated=false;soundVolume=0,minimapAngle=270,defaultPublish="GUILD",};
...
n=x(a,l+60,e.locale["OPT_AUTO_OPEN3"],"openLogIn",false,d,r,1,.82,0);
