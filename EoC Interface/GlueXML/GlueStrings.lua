...
ABILITY_INFO_TUSKARR1 = "- Fishing skill increased.";
ABILITY_INFO_TUSKARR2 = "- Weapon expertise increased";
ABILITY_INFO_TUSKARR3 = "- May ensnare foes with a net";
ABILITY_INFO_TUSKARR4 = "- Resistant to Frost.";
...
ACCOUNT_MESSAGE_BODY_NO_READ_URL = "http://eoc.dispersion-wow.com/scripts/accountmessaging/getMessageBodyUnread.php";
ACCOUNT_MESSAGE_BODY_URL = "http://eoc.dispersion-wow.com/scripts/accountmessaging/getMessageBody.php";
ACCOUNT_MESSAGE_BUTTON_READ = "Mark as read";
ACCOUNT_MESSAGE_HEADERS_URL = "http://eoc.dispersion-wow.com/scripts/accountmessaging/getMessageHeaders.php";
ACCOUNT_MESSAGE_READ_URL = "http://eoc.dispersion-wow.com/scripts/accountmessaging/markMessageAsRead.php";
...
AUTH_BANNED = "This account has been banned.";
...
AUTH_OK = "Welcome To Edge of Chaos";
...
AUTH_SUSPENDED = "This account has been temporarily suspended.";
...
BLIZZ_DISCLAIMER = "Copyright 2009-2014 Edge of Chaos. All Rights Reserved.";
BLOCK = "BLOCK %.2f";
BLOODELF_DISABLED = "Blood Elf\nRequires The Burning Crusade";
TUSKARR_DISABLED = "Tuskarr\nRequires Edge of Chaos";
...
CHAR_CREATE_LEVEL_REQUIREMENT = "You must have an existing character of at least level 30 on to create a Demon Hunter.";
...
CHAR_CREATE_UNIQUE_CLASS_LIMIT = "You may only have one Hero Class character on this realm.";
...
CLASS = "Class";
CLASS_ENGINEER = "NEEDS FILLING.";
CLASS_ENGINEER = "NEEDS FILLING.";
CLASS_ENGINEER_MALE = "NEEDS FILLING.";
CLASS_ENGINEER_FEMALE = "NEEDS FILLING.";
CLASS_DEMONHUNTER = "These demonic hunters have now allied themselves with the Alliance or Horde. Demon Hunters are a hero class, which means they start at higher level. Demon Hunters use energy as their primary resource. |n|nDemon Hunters have the capability of choosing between ranged or melee specializations with an emphasis of controlling the demonic powers from within, harnassing arcane and fire energies.Their primary stat is Agility, Haste and also Stamina if tanking.";
CLASS_DEMONHUNTER_FEMALE = "These demonic hunters have now allied themselves with the Alliance or Horde. Demon Hunters are a hero class, which means they start at higher level. Demon Hunters use energy as their primary resource. |n|nDemon Hunters have the capability of choosing between ranged or melee specializations with an emphasis of controlling the demonic powers from within, harnassing arcane and fire energies.Their primary stat is Agility, Haste and also Stamina if tanking.";
...
CLASS_INFO_ENGINEER0 = "- Role: YOUR MUM";
CLASS_INFO_ENGINEER1 = "- Mail";
CLASS_INFO_ENGINEER2 = "- Noobs.";
CLASS_INFO_ENGINEER3 = "- Start at level 10.";
CLASS_INFO_ENGINEER4 = "- BOMBS.";
CLASS_INFO_ENGINEER5 = "- Uses focus and bombs.";
CLASS_INFO_DEMONHUNTER0 = "- Role: Damage";
CLASS_INFO_DEMONHUNTER1 = "- Medium Armor (Leather)";
CLASS_INFO_DEMONHUNTER2 = "- Former servant of the Illidari";
CLASS_INFO_DEMONHUNTER3 = "- Start at level 10.";
CLASS_INFO_DEMONHUNTER4 = "- Option to choose between ranged or melee combat and use of spells with demonic, arcane, and fire energies.";
CLASS_INFO_DEMONHUNTER5 = "- Uses energy as a resource.";
...
COMMUNITY_URL = "https://dispersion-wow.com/";
...
DAYS_ABBR = "|4Day:Days;";
DEATHKNIGHT_DISABLED = "Engineer\nRequires a level 30.";
DEMONHUNTER_DISABLED = "Engineer\nRequires a level 30.";
...
DISCONNECTED = "The server has restarted. It will be back up imminently.";
DISPLAY = "Display";
DMG = "DMG";
DODGE = "DODGE %.2f";
DONE = "Done";
...
ENTER_EMAIL = "Username (NOT email)";
...
LOGINSCREENOPTIONS_MENU = "Loginscreen";
LOGINSCREENOPTIONS_2D = "2D";
LOGINSCREENOPTIONS_LOW = "Low";
LOGINSCREENOPTIONS_MEDIUM = "Medium";
LOGINSCREENOPTIONS_HIGH = "High";
LOGINSCREENOPTIONS_ULTRA = "Ultra";
LOW = "Low";
MAGE_DISABLED = "Mage\nYou must choose a different race to be this class.";
MALE = "Male";
...
RACE_INFO_TUSKARR = "Though they have done well to evade the undead Scourge, the tuskarr know that it is only a matter of time before the legion comes calling. Tribes broken into a civil war, the elders of the Kal'uak clan strive to lead their people to safety as they have made enemies with the runic army of the  I'kulua clan.  Few of the Kal'uak fled to the Icecap Isles, where they now seek allies in their battle against the Burning Legion and the I'kulua clan.";
RACE_INFO_TUSKARR_FEMALE = "Though they have done well to evade the undead Scourge, the tuskarr know that it is only a matter of time before the legion comes calling. Tribes broken into a civil war, the elders of the Kal'uak clan strive to lead their people to safety as they have made enemies with the runic army of the  I'kulua clan.  Few of the Kal'uak fled to the Icecap Isles, where they now seek allies in their battle against the Burning Legion and the I'kulua clan.";
...
RACE_INFO_GOBLIN = "TO DO."
RACE_INFO_GOBLIN_FEMALE = "TO DO."
RACE_INFO_WORGEN = "TO DO."
RACE_INFO_WORGEN_FEMALE = "TO DO."
...
SERVER_ALERT_BETA_URL = "http://eoc.dispersion-wow.com/scripts/serveralert/index.php";
SERVER_ALERT_BUTTON_TEXT = "More Info";
SERVER_ALERT_PTR_URL = "http://eoc.dispersion-wow.com/scripts/serveralert/index.php";
SERVER_ALERT_TITLE = "Breaking News";
SERVER_ALERT_URL = "http://eoc.dispersion-wow.com/scripts/serveralert/index.php";
